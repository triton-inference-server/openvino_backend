...
MODEL_CONFIG = {
        ...
        "dynamic": {
            "enable": True,
            "fetch": dynamic_model,
            "configurations": [CPU], # [GPU] PriorBoxClustered op is not supported in GPU plugin yet.
            "shape": [
                (1, 3, 224, 224),
                (2, 3, 224, 224),
                (3, 3, 224, 224),
...
models = list(filter(lambda it: MODEL_CONFIG[it]["enable"] == True, MODEL_CONFIG.keys()))
